...
The major difference seems to be the lower latency of the feedback loop with writing. With programming, my brain at times feels like it overheats as I really strain myself to fix a difficult bug or have to grok a completely unknown API. With writing, my mind is more zen and slower. Not feeling much tension as I jot some words down, imagining myself as someone else in a different world.

I didn't realize how tiring just staring at a screen for hours is. It seems my brains get quite hazy from it which, consequently, hampers the brain work needed for writing. Minimzing the screen time seems to leave me sharper and less "zombified" to actually produce something
